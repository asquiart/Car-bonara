...
namespace CarbonaraWebAPI.Migrations
{
    ...
    [Migration("20220721145324_Added Bill Position fix")]
    partial class AddedBillPositionfix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarbonaraWebAPI.Model.DAO.BillPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarbonaraWebAPI.Model.DAO.BillPosition", b =>
                {
                    b.HasOne("CarbonaraWebAPI.Model.DAO.Bill", null)
                        .WithMany("Positions")
            ...
            modelBuilder.Entity("CarbonaraWebAPI.Model.DAO.Booking", b =>
                {
                    b.HasOne("CarbonaraWebAPI.Model.DAO.Bill", "Bill")
                        .WithMany()
                        .HasForeignKey("BillId");
